<?php 
if(isset($_POST['Sumbit_Mail_List'])){
    $name = $_POST['theName'];
    $phone = $_POST['phone'];
    $email = $_POST['email'];
    ...
    if($email==""){
        ...
        $query = "INSERT INTO mailing_list (name,phone,email) VALUES ('$name','$phone','$email')";
        $success = mysqli_query($con, $query);
        if($success){
        $inserted = "<h2>Thanks!</h2><h3>You're gonna see some emails</h3>";
        }else{
...
<link href="style.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            if(phone==""){
                phoneMsg.innerHTML = "Your phone number cannot be blank."; return false;
            }
            if(email==""){
                emailMsg.innerHTML = "Your email address cannot be blank."; return false;
            }
        }
    </script>
</head>
...
<div id="wrapper">
	...
	<h2>Mailing List Sign-Up</h2>
        ...
        <p>
            <input type="submit" name="Sumbit_Mail_List" value="Sumbit">
        </p>
        </form> <?php } ?>
	</section>
